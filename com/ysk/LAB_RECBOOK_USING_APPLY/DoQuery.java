...
public class DoQuery extends _hproc {
	...
	public String action(String value) throws Throwable {
		...
		/**
		 * 以下開始為非主檔資料表資料.
		 * 查詢簽核狀態的SQL指令 直接用字串參數丟進去做為DB欄位名稱,"簽核狀態"為 table header,0表示在setQueryTable中不做為查詢條件.
		 */
		...
		// 研發"處" 所以取ParentNo
		// 研發一 二課 的人 上一層是研發處 :13 此處用 getParentNo 涵蓋 一 ,二課  & 研發處的人:13
		if (user.getParentNo() == 13 || user.getDepNo() == 13) {
		...
		/**
		 * 參數 5,6 代表 LIST當中的元素位置,會使用到含"員工編號"&"簽核狀態"的元素,各位於list第5和第6的位置.(ArrayList從0開始算)
		 * 
